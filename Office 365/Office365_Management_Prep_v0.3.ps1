...
if ($OSversion -like "*Windows Server 2012*")
	{
        # Install .NET Framework 3.5 Windows Server 2012 and Server 2012 R2
...
if ($OSversion -like "Microsoft Windows 7*" -or "Microsoft Windows 8*")
	{
        # Install .NET Framework 3.5 Windows 7 or Windows 8
       # $NetFrameInstall = Get-WindowsFeature NET-Framework-Core
